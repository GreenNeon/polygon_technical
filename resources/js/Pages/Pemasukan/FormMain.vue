<template>
	<div id="Form-Main-Pemasukan">
		<jet-form-section @submitted="sendForm">
			<template #title> Informasi Pemasukan </template>

			<template #description>
				Isi untuk data pemasukan utama yang akan disimpan.
				<br />
				<b>Wajib Diisi</b>
			</template>
			...
			<template #form>
				...
				<div class="col-span-6 sm:col-span-12">
					...
					<textarea
						...
						:disabled="readonly"
					></textarea>
					<small class="mx-1 text-gray-500">Keterangan pemasukan.</small>
